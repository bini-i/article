...
RSpec.describe User, type: :model do
  describe 'validations' do
    subject { User.new(user_name: 'user1') }
  ...
  describe 'instance methods' do
    describe '#already_voted?' do
      it 'checks if a user voted for an article' do
        user1 = User.create(id: 1, user_name: 'user1', password: '123456', password_confirmation: '123456')
    ...
    describe '#upvote' do
      it 'adds a vote record of a user and article' do
        user1 = User.create(id: 1, user_name: 'user1', password: '123456', password_confirmation: '123456')
        user2 = User.create(id: 2, user_name: 'user2', password: '123456', password_confirmation: '123456')
